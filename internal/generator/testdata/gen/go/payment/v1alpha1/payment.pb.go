...
var file_payment_v1alpha1_payment_proto_rawDesc = []byte{
	...
	0x52, 0x5f, 0x41, 0x50, 0x50, 0x4c, 0x45, 0x10, 0x03, 0x42, 0xde, 0x01, 0x0a, 0x14, 0x63, 0x6f,
	...
	0x72, 0x65, 0x6b, 0x65, 0x72, 0x2f, 0x74, 0x77, 0x69, 0x72, 0x70, 0x2d, 0x6f, 0x70, 0x65, 0x6e,
	...
	0x61, 0x74, 0x61, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x70, 0x61, 0x79, 0x6d, 0x65,
	0x6e, 0x74, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0xa2, 0x02, 0x03, 0x50, 0x58,
...
var file_payment_v1alpha1_payment_proto_goTypes = []any{
...
func file_payment_v1alpha1_payment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_payment_v1alpha1_payment_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Order); i {
			case 0:
				return &v.state
			case 1:
